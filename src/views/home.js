    ...
    <div className="home-container">
        ...
        <div className="home-navbar">
          <div className="home-left-side">
            ...
            <div className="home-links-container">
              ...
              <a href="#aboutus" className="home-link01 anchor">
                About Us
              </a>
              <a href="#products" className="home-link02 anchor">
                products
              </a>
          ...
          <div className="home-right-side">
            <a
              href="https://www.youtube.com/channel/UCqS2DwrgTAQiYU9ZZlP4XqA"
              target="_blank"
        ...
        <div className="home-content-container">
          <div className="home-hero-text">
            <h1 className="home-heading section-Heading">
              Shimyytrov Music Team
            </h1>
            <span className="home-text section-Text">From Hong Kong</span>
            <a href="#aboutus" className="home-cta-btn1 anchor button">
              ABOUT US
            </a>
          </div>
        </div>
      </div>
      <div id="aboutus" className="home-features">
        <div className="home-heading-container">
          <h2 className="home-text01 section-Heading">About Us</h2>
        </div>
        <div className="home-cards-container">
          <div className="home-features-card">
            ...
            <div className="home-text-container">
              <span className="home-heading01 card-Heading">Fact #1</span>
              <span className="home-text02 card-Text">
                <span>The &quot;team&quot; only have one member.</span>
                <br></br>
                <span></span>
                <br></br>
                <span>All of the works are done by a 14 years-old kid.</span>
              </span>
            </div>
          </div>
          <div className="home-features-card1">
            ...
            <div className="home-text-container1">
              <span className="home-heading02 card-Heading">Fact #2</span>
              <span className="home-text08 card-Text">
                <span>All software I use are free.</span>
                <br></br>
                <span></span>
                <br></br>
                <span>(Check&apos;em here)</span>
              </span>
            </div>
          </div>
          <div className="home-features-card2">
            ...
            <div className="home-text-container2">
              <span className="home-heading03 card-Heading">Fact #3</span>
              <span className="home-text14 card-Text">
                <span>
                  At first, the name of our team was &quot;Levi Yamiyoshin Music
                  Channel&quot;. (Because LYMC was came from
                  <span
                ...
                <a
                  href="https://www.youtube.com/channel/UCbOBfB7ODrJKOMoT8M9fDxw"
                  target="_blank"
                  rel="noreferrer noopener"
                >
                  <span className="home-text16">LYGC</span>
                </a>
                <span>). More in Fact #4</span>
              </span>
            </div>
          </div>
          <div className="home-features-card3">
            ...
            <div className="home-text-container3">
              <span className="home-heading04 card-Heading">Fact #4</span>
              <span className="home-text18 card-Text">
                <span>
                  The reason that we( I ) change the name was because I created
                  a virtual country named
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
                ...
                <a
                  href="https://discord.gg/P25pDM4mkr"
                  target="_blank"
                  rel="noreferrer noopener"
                >
                  <span className="home-text20">
                    &quot;Shimyytrov Democratic Federal Empire&quot;(At first it
                    was Darkness Empire)
                  </span>
                </a>
                <span>. I&apos;ll release some tracks related to SDFE.</span>
              </span>
            </div>
          </div>
          <div className="home-features-card4">
            ...
            <div className="home-text-container4">
              <span className="home-heading05 card-Heading">Fact #5</span>
              <span className="home-text22 card-Text">
                <span>
                  Maybe we&apos;re going off-topic now. I&apos;m just a student
                  from Hong Kong. And my english is bad(At least better than my
                  classmates). So you will find many Chinese words in some of my
                  website.
                </span>
              </span>
            </div>
          ...
          <div className="home-features-card5">
            ...
            <div className="home-text-container5">
              <span className="home-heading06 card-Heading">Fact #6</span>
              <span className="home-text24 card-Text">
                On 05 May 2022, I turned an album to privet(You can&apos;t
                access them on YouTube anymore) because that was my first
                release and those tracks sound bad.
              </span>
            </div>
          </div>
        </div>
      </div>
      <div id="products" className="home-services">
        <div className="home-heading-container1">
          <h1 className="home-text25 section-Heading">Our Products</h1>
          <span className="home-text26 section-Text">Check&apos;em out!</span>
        </div>
        <div className="home-cards-container1">
          <div className="home-service-card">
            <h3 className="home-text27 card-Heading">Original Tracks</h3>
            <span className="home-text28 card-Text">
              I release my tracks on YouTube. You can click the button on the
              top-right side to access my channel.
            </span>
            <a
              href="https://www.youtube.com/channel/UCqS2DwrgTAQiYU9ZZlP4XqA"
              target="_blank"
          ...
          <div className="home-service-card1">
            <h3 className="home-text29 card-Heading">SoundFonts</h3>
            <span className="home-text30 card-Text">
              Basically, I make them for myself. But I think maybe you&apos;ll
              need them for your products. Check&apos;em out.
            </span>
            <span className="anchor">Check here</span>
          </div>
          <div className="home-service-card2">
            <h3 className="home-text31 card-Heading">Remix</h3>
            <span className="home-text32 card-Text">
              Well, you can check them in our album &quot;Remix&quot;. But I
              think they&apos;ll down due to copyrights one day.
            </span>
            <a
              href="https://www.youtube.com/playlist?list=PLfZpaZddLoXh4FU0O_ijOg0i7bxQXdWqy"
              target="_blank"
              rel="noreferrer noopener"
              className="home-link12 anchor"
            >
              here
            </a>
          </div>
      ...
      <div className="home-team">
        <div className="home-heading-container2">
          <h1 className="home-text33 section-Heading">Meet the Team</h1>
          <span className="home-text34 section-Text">
            <span>Here&apos;s a list of the team member&quot;s&quot;.</span>
          </span>
        </div>
        <div className="home-cards-container2">
          <div className="home-team-card">
            <div className="home-avatar-container">
              <img
                alt="image"
                src="https://github.com/ShimyytrovMusicTeam/ShimyytrovMusicTeam.github.io/blob/main/home/ShimyytrovGov.png?raw=true"
                className="home-image2"
              />
            </div>
            <span className="home-name card-Heading">
              Levi Alexandra Morozov
            </span>
            <span className="home-position card-Text">
              Leader, music, YouTube channel, etc.
            </span>
          </div>
          <div className="home-team-card1">
            ...
            <span className="home-name1 card-Heading">Empty</span>
            <span className="home-position1 card-Text">Yes. Empty</span>
          </div>
          <div className="home-team-card2">
            ...
            <span className="home-name2 card-Heading">Empty</span>
            <span className="home-position2 card-Text">Still empty.</span>
          </div>
          <div className="home-team-card3">
            ...
            <span className="home-name3 card-Heading">Empty</span>
            <span className="home-position3 card-Text">Empty.</span>
          </div>
          <div className="home-team-card4">
            ...
            <span className="home-name4 card-Heading">Empty</span>
      ...
      <div id="ourstory" className="home-our-story">
        <div className="home-heading-container3">
          <h1 className="home-text37 section-Heading">Our story</h1>
          ...
          <div className="home-right-section">
            ...
            <div className="home-card1">
              ...
              <div className="home-content-container3">
                <span className="home-text46 smallCard-Heading">
                  This text is the name of the article. Lorem ipsum dolor sit
                  metsed ...
                </span>
                <span className="anchor">Read more</span>
            ...
            <div className="home-card2">
              ...
              <div className="home-content-container4">
                <span className="home-text49 smallCard-Heading">
                  This text is the name of the article. Lorem ipsum dolor sit
                  metsed ...
                </span>
                <span className="anchor">Read more</span>
            ...
            <div className="home-card3">
              ...
              <div className="home-content-container5">
                <span className="home-text52 smallCard-Heading">
                  This text is the name of the article. Lorem ipsum dolor sit
                  metsed ...
                </span>
                <span className="anchor">Read more</span>
      ...
      <div className="home-get-in-touch">
        <h2 className="home-text55 section-Heading">Get in touch</h2>
